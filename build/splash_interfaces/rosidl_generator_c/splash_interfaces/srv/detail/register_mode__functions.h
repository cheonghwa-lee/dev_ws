...
#ifndef SPLASH_INTERFACES__SRV__DETAIL__REGISTER_MODE__FUNCTIONS_H_
#define SPLASH_INTERFACES__SRV__DETAIL__REGISTER_MODE__FUNCTIONS_H_
...
/// Initialize srv/RegisterMode message.
/**
...
/// Finalize srv/RegisterMode message.
/**
...
/// Create srv/RegisterMode message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * splash_interfaces__srv__RegisterMode_Request__init().
...
/// Destroy srv/RegisterMode message.
/**
 * It calls
 * splash_interfaces__srv__RegisterMode_Request__fini()
...
/// Initialize array of srv/RegisterMode messages.
/**
...
/// Finalize array of srv/RegisterMode messages.
/**
 * It calls
 * splash_interfaces__srv__RegisterMode_Request__fini()
...
/// Create array of srv/RegisterMode messages.
/**
 * It allocates the memory for the array and calls
 * splash_interfaces__srv__RegisterMode_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RegisterMode messages.
/**
 * It calls
 * splash_interfaces__srv__RegisterMode_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * splash_interfaces__srv__RegisterMode_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_splash_interfaces
...
/**
 * It calls
 * splash_interfaces__srv__RegisterMode_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_splash_interfaces
...
/**
 * It allocates the memory for the array and calls
 * splash_interfaces__srv__RegisterMode_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_splash_interfaces
...
/**
 * It calls
 * splash_interfaces__srv__RegisterMode_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SPLASH_INTERFACES__SRV__DETAIL__REGISTER_MODE__FUNCTIONS_H_
