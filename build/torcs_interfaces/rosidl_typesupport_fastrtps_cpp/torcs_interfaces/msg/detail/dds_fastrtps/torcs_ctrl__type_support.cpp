...
#include "torcs_interfaces/msg/detail/torcs_ctrl__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const torcs_interfaces::msg::TORCSCtrl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<torcs_interfaces::msg::TORCSCtrl *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TORCSCtrl__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const torcs_interfaces::msg::TORCSCtrl *>(
...
{
  return max_serialized_size_TORCSCtrl(full_bounded, 0);
}

static message_type_support_callbacks_t _TORCSCtrl__callbacks = {
...
static rosidl_message_type_support_t _TORCSCtrl__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TORCSCtrl__callbacks,
...
{
  return &torcs_interfaces::msg::typesupport_fastrtps_cpp::_TORCSCtrl__handle;
}
