...
static const _TORCSCtrl_type_support_symbol_names_t _TORCSCtrl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, torcs_interfaces, msg, TORCSCtrl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, torcs_interfaces, msg, TORCSCtrl)),
  }
};
...
get_message_type_support_handle<torcs_interfaces::msg::TORCSCtrl>()
{
  return &::torcs_interfaces::msg::rosidl_typesupport_cpp::TORCSCtrl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, torcs_interfaces, msg, TORCSCtrl)() {
  return get_message_type_support_handle<torcs_interfaces::msg::TORCSCtrl>();
}
